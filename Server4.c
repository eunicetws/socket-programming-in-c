...
//Task 4  - Anonymous (2023)
    } else if(strcmp(buffer, "Time")==0){
        snprintf(buffer, 1024, "%2d:%02d\n", (ptm->tm_hour+8)%24, ptm->tm_min);     // this is MTC - ptm->tm_hour+8 add 8 to hours and put to 24 hour format
